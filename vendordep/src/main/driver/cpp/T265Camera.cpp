...
JNIEXPORT jlong JNICALL Java_com_spartronics4915_lib_hardware_sensors_T265Camera_newCamera(JNIEnv *env, jobject thisObj, jstring mapPath)
{
    try
    {
...
JNIEXPORT void JNICALL Java_com_spartronics4915_lib_hardware_sensors_T265Camera_sendOdometryRaw(JNIEnv *env, jobject thisObj, jint sensorId, jfloat xVel, jfloat yVel)
{
    try
    {
        ensureCache(env, thisObj);
...
JNIEXPORT void JNICALL Java_com_spartronics4915_lib_hardware_sensors_T265Camera_exportRelocalizationMap(JNIEnv *env, jobject thisObj, jstring savePath)
{
    try
    {
        ensureCache(env, thisObj);
...
JNIEXPORT void JNICALL Java_com_spartronics4915_lib_hardware_sensors_T265Camera_setOdometryInfo(JNIEnv *env, jobject thisObj, jfloat xOffset, jfloat yOffset, jfloat angOffset, jdouble measureCovariance)
{
    try
    {
        ensureCache(env, thisObj);
...
JNIEXPORT void JNICALL Java_com_spartronics4915_lib_hardware_sensors_T265Camera_free(JNIEnv *env, jobject thisObj)
{
    try
    {
        ensureCache(env, thisObj);
...
JNIEXPORT void JNICALL Java_com_spartronics4915_lib_hardware_sensors_T265Camera_cleanup(JNIEnv *env, jclass)
{
    try
    {
        std::lock_guard<std::mutex> lock(tbcMutex);
